...
N=512; % Number of samples in the signal (note! the script is written only for N with even integers)
...
% calculate spectrum
S=abs(fft(s,N1)); % Note, we are looking for the frequency, hence the magnitude of the spectrum is fully sufficient
S=S(1:N1/2+1)/N1; % Real data gives symmetric spectrum, half is enough. Division by N to get the correct amplitude
