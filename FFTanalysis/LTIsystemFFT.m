...
b=[1 -1]; % bk coefficients for LTI FIR system. In this example, it is a one-sample difference
...
n=0:N-1;
A=2; % Amplitude
k=45; % gives the system's absH(k+1)=1.0018 and argH(k+1)=1.0462 rad (compensation for MATLAB's vector index starting at 1)
fas=0; % Phase given in degrees
s=A*sin((2*pi/N)*k*n+fas*(pi/180)); % pure signal
