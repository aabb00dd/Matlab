...
b=[0 1]; %bk koefficienter f?r LTI FIR system. I detta exemlep ?r det one sample difference.
...
s=A * cos(w*n+fas*(pi/180)) + 1i * sin(w*n+fas*(pi/180)); %signal med en frekvenskomponent
