...
b = [0 1]; % bk coefficients for LTI FIR system (in this example it's a one sample difference)
...
s = A * cos(w*n + phase*(pi/180)) + 1i * sin(w*n + phase*(pi/180)); % Signal with one frequency component
