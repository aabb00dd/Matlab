...
N=512; %Antal sampel i signalen (obs! skriptet är skriven bara för N med jämna heltal)
...
%beräkna spektrum
S=abs(fft(s,N1)); %Obs, vi letar efter frekvensen, därav magnituden av spektrat fullt duglig
S=S(1:N1/2+1)/N1; %Reell data ger symetrisk spektrum, räcker halvan. Division med N för att få rätt amplitud
